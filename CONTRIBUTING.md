...
1. Make an [Issue](https://github.com/sensengames/unity-sensen-state-machine/issues/new)
...
```json
    {
        "dependencies": {
            "com.sensengames.unity-sensen-state-machine": "https://github.com/YOUR_USER/unity-sensen-state-machine.git"
        }
    }
```
